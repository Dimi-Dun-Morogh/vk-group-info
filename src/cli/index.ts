...
export default ()=> {
  ...
  ----------------------------------------------------------------------------------------
  postersbychars - выведет в консоль топ 20 постеров по количеству символов
  ----------------------------------------------------------------------------------------
  commentatorssbychars - выведет в консоль топ 20 коментаторов по количеству символов
  ----------------------------------------------------------------------------------------
  ...
  rl.on('line', async (line) => {
    switch (line.split(' ')[0]) {
      ...
      case 'postersbychars':
      await VkGrpInfo.topPostersByChar();
      break;
      case 'commentatorssbychars':
